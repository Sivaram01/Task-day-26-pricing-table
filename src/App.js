  ...
  <div className="container">
    <div className="row">
      ...
      <div className="col-lg-4">
        <div className="card mb-5  mb-lg-0 carding ">
          <div className="card-body">
            <h5 className="card-title text-muted text-uppercase text-center">Free</h5>
            <h6 className="card-price text-center"><span className = "price">$0 </span>
      ...
      <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <h6 className="card-price text-center"> <span className = "price">$9</span>
            <span className="period">/month</span></h6>
            <hr/>
            <ul className="fa-ul">
      ...
      <div className="col-lg-4">
        <div className="card">
          <div className="card-body">
            ...
            <h6 className="card-price text-center"><span className = "price">$49</span>
            <span className="period">/month</span></h6>
            <hr/>
            <ul className="fa-ul">
